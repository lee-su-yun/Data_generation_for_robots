...
async def create_robot_plan_and_save(
    ...
    system_prompt = (
        ...
        "Then provide a full high-level plan (e.g., \"Pick cup 3\", \"Move cup 3 to right\", etc.), and assign each plan to a step interval (e.g., step 1–3).\n\n"
        "## 2. For Each Step, Write the Following:\n"
        "Each action step must include:\n"
        "[Step X]\n"
        "<TASK> Description of the remaining task(s) at this point.\n"
        "<PLAN> The full remaining high-level plan.\n"
...
if __name__ == "__main__":
    ...
    task = "Move the pink plastic cup to the center of the table without knocking over any other cups." #"Clean up the desk."

    output_json_path = "/home/sylee/codes/Data_generation_for_robots/test.json"
