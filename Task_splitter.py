...
async def create_robot_plan_and_save(
    ...
    system_prompt = (
        ...
        "   - 1 initial images:\n"
        "    - 1 ego-view images (top view)\n"
        "   - 1 final images: same format as above\n"
#        "  - 3 initial images:\n"
...
#        "  - 3 final images: same format as above\n"
    ...
    #    "    - Ego-top view, Ego-side view, Exo-wrist view\n"
         "# Image Convention:\n"
        "- You will receive 2 images in total:\n"
        "  - The first image represent the initial state of the environment:\n"
