...
prompt = {"A tabletop robotic manipulation scene showing a one-arm robot with a gripper, "
        "executing a task on a white table. The red plastic cup is upright on the left side of the table, 20 cm from the edge. The blue paper cup is upright on the right side, 20 cm from the edge. A white tissue is folded and lying flat on the center of the table, 10 cm from the red cup. "
